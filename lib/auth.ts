...
export async function signIn(email: string, password: string) {
  ...
  console.log("User ID after signInWithPassword:", data.user?.id); // Added log
  ...
  try {
    ...
    console.log("Fetched profile from user_profiles:", { fetchedProfile, fetchError }); // Added log
  ...
  console.log("Profile data before attaching to user:", profileData); // Added log
  ...
  console.log("Final data.user.profile before return:", data.user?.profile); // Added log
