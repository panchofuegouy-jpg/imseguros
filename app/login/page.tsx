...
export default function LoginPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (data.user) {
      ...
      if (userRole === "admin") {
        console.log("Redirecting to /admin (full reload)");
        window.location.href = "/admin";
      } else if (userRole === "client") {
        console.log("Redirecting to /cliente (full reload)");
        window.location.href = "/cliente";
      } else {
        console.log("Redirecting to /dashboard (default, full reload)");
        window.location.href = "/dashboard"; // Default redirect for other roles or if role is not found
      }
    }
